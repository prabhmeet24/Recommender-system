...
def fetch_poster(id):
    url = "https://api.themoviedb.org/3/movie/{}?language=en-US&api_key=97a9ab43500f4bd30dbc567861564ad4".format(id)
...
movies_df = pickle.load(open('movies_dict.pkl','rb'))
...
movie_list = list(movies_df['title'].values)
